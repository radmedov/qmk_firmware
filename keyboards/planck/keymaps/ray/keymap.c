 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |BL/Shift|Ctrl| Alt  | CMD  |Lower |Sp/Sh |Sp/Ctrl|Raise|   /  | Left | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    BACKLIT, KC_LCTL,KC_LALT,KC_LGUI,LOWER,MT(MOD_LSFT, KC_SPC),MT(MOD_LCTL, KC_SPC),RAISE,KC_SLSH,KC_LEFT,KC_DOWN,KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    ONEPASS, _______, _______, _______, _______, _______, _______, _______,     VSSHOT,  _______, _______, _______
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______,   SSHOT, KC_MNXT, KC_MPLY, KC_VOLD
),
